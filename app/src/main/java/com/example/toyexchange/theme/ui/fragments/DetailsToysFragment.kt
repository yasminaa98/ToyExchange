...
class DetailsToysFragment:Fragment(R.layout.toy_item){
    ...
    override fun onCreateView(
        ...
        detailsToyViewModel = ViewModelProvider(this,detailsViewModelFactory)[DetailsToyViewModel::class.java]
        //onFavoriteClick()
        //maintain checkbox state :
        val toyId = arguments?.getInt("id")
        val sharedPreferences = requireActivity().getSharedPreferences("my_checkbox_${toyId}",Context.MODE_PRIVATE)
